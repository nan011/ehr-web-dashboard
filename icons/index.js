...
export const DashboardIcon = createIcon("/icons/dashboard.svg");
export const BellIcon = createIcon("/icons/bell.svg");
export const QuestionMarkIcon = createIcon("/icons/question-mark.svg");
export const GearIcon = createIcon("/icons/gear.svg");
export const OpenedDoorIcon = createIcon("/icons/opened-door.svg");
